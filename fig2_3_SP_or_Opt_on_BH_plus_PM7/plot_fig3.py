...
for dirt in dir_list:
	...
	target_path=os.path.join(target_path, 'Opt')
	...
	ax1.text(0.17,0.11, 'RMSE_ANI-2x=%s kcal/mol'%format(RMSE_BE,'.2f'), transform=ax1.transAxes,fontsize=fontsize)
	ax1.text(0.17,0.03, 'RMSE_PM7=%s kcal/mol'%format(RMSE_BE_PM7,'.2f'), transform=ax1.transAxes,fontsize=fontsize)
...
plt.tight_layout()	
plt.savefig('./fig3_Opt_on_BH_plus_PM7.jpeg',dpi=dpi_numb)	